...
exports.crudGetManyReference = exports.CRUD_GET_MANY_REFERENCE_SUCCESS = exports.CRUD_GET_MANY_REFERENCE_FAILURE = exports.CRUD_GET_MANY_REFERENCE_LOADING = exports.CRUD_GET_MANY_REFERENCE = exports.crudGetMatching = exports.CRUD_GET_MATCHING_SUCCESS = exports.CRUD_GET_MATCHING_FAILURE = exports.CRUD_GET_MATCHING_LOADING = exports.CRUD_GET_MATCHING = exports.crudGetMany = exports.CRUD_GET_MANY_SUCCESS = exports.CRUD_GET_MANY_FAILURE = exports.CRUD_GET_MANY_LOADING = exports.CRUD_GET_MANY = exports.crudDelete = exports.CRUD_DELETE_SUCCESS = exports.CRUD_DELETE_FAILURE = exports.CRUD_DELETE_LOADING = exports.CRUD_DELETE = exports.crudUpdate = exports.CRUD_UPDATE_SUCCESS = exports.CRUD_UPDATE_FAILURE = exports.CRUD_UPDATE_LOADING = exports.CRUD_UPDATE = exports.crudCreate = exports.CRUD_CREATE_SUCCESS = exports.CRUD_CREATE_FAILURE = exports.CRUD_CREATE_LOADING = exports.CRUD_CREATE = exports.crudGetOne = exports.CRUD_GET_ONE_SUCCESS = exports.CRUD_GET_ONE_FAILURE = exports.CRUD_GET_ONE_LOADING = exports.CRUD_GET_ONE = exports.crudGetList = exports.CRUD_GET_LIST_SUCCESS = exports.CRUD_GET_LIST_FAILURE = exports.CRUD_GET_LIST_LOADING = exports.CRUD_GET_LIST = exports.crudGetMore = exports.CRUD_GET_MORE_SUCCESS = exports.CRUD_GET_MORE_FAILURE = exports.CRUD_GET_MORE_LOADING = exports.CRUD_GET_MORE = undefined;

var _types = require('../rest/types');

var CRUD_GET_MORE = exports.CRUD_GET_MORE = 'AOR/CRUD_GET_MORE';
var CRUD_GET_MORE_LOADING = exports.CRUD_GET_MORE_LOADING = 'AOR/CRUD_GET_MORE_LOADING';
var CRUD_GET_MORE_FAILURE = exports.CRUD_GET_MORE_FAILURE = 'AOR/CRUD_GET_MORE_FAILURE';
var CRUD_GET_MORE_SUCCESS = exports.CRUD_GET_MORE_SUCCESS = 'AOR/CRUD_GET_MORE_SUCCESS';

var crudGetMore = exports.crudGetMore = function crudGetMore(resource, pagination, sort, filter) {
    ...
    return {
        ...
        meta: { resource: resource, fetch: _types.GET_MORE, cancelPrevious: cancelPrevious }
    };
};
...
var crudGetOne = exports.crudGetOne = function crudGetOne(resource, id, include, basePath) {
    var cancelPrevious = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
    return {
        type: CRUD_GET_ONE,
        payload: { id: id, include: include, basePath: basePath },
...
var crudDelete = exports.crudDelete = function crudDelete(resource, id, previousData, basePath) {
    ...
    return {
        type: CRUD_DELETE,
        payload: { id: id, previousData: previousData, basePath: basePath, redirectTo: redirectTo },
...
var crudGetManyReference = exports.crudGetManyReference = function crudGetManyReference(reference, target, id, relatedTo, pagination, sort, filter) {
    return {
        ...
        meta: {
            resource: reference,
            relatedTo: relatedTo,
            fetch: _types.GET_MANY_REFERENCE,
            cancelPrevious: false
        }
    };
};