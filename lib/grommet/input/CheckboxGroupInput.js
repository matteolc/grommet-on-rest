...
var CheckboxGroupInputComponent = exports.CheckboxGroupInputComponent = function (_Component) {
    ...
    function CheckboxGroupInputComponent() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = CheckboxGroupInputComponent.__proto__ || Object.getPrototypeOf(CheckboxGroupInputComponent)).call.apply(_ref, [this].concat(args))), _this), _this.handleCheck = function (event) {
            var _this$props$input = _this.props.input,
                value = _this$props$input.value,
                onChange = _this$props$input.onChange;

            var isChecked = value ? value.find(function (v) {
...
var CheckboxGroupInput = (0, _compose2.default)(_translate2.default)(CheckboxGroupInputComponent);
