    ...
    (0, _createClass3.default)(ReferenceManyField, [{
        ...
        value: function render() {
            ...
            if (typeof ids === 'undefined') {
                return _react2.default.createElement(_Spinning2.default, null);
            }
...
ReferenceManyField.propTypes = {
    ...
    sort: _propTypes2.default.shape({
        ...
        order: _propTypes2.default.oneOf([_queryReducer.SORT_ASC, _queryReducer.SORT_DESC])
    }),
...
ReferenceManyField.defaultProps = {
    filter: {},
    perPage: 25,
    sort: { field: 'id', order: _queryReducer.SORT_DESC },
    source: ''
};
