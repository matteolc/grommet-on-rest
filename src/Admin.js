...
import DefaultLayout from './grommet/layout/Layout';
import Menu from './grommet/layout/Menu';
import Login from './grommet/auth/Login';
import Signup from './grommet/auth/Signup';
import Logout from './grommet/auth/Logout';
                    ...
                    <div>
                        <Switch>
                            ...
                            {allowSignup && <Route
                                ...
                                path="/signup"
                                render={({ location }) =>
                                    createElement(signupPage || Signup, {
                                        location,
                                        title,
                                        theme,
                                        loginTexture,
