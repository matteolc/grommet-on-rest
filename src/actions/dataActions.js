...
export const CRUD_GET_MORE = 'AOR/CRUD_GET_MORE';
export const CRUD_GET_MORE_LOADING = 'AOR/CRUD_GET_MORE_LOADING';
export const CRUD_GET_MORE_FAILURE = 'AOR/CRUD_GET_MORE_FAILURE';
export const CRUD_GET_MORE_SUCCESS = 'AOR/CRUD_GET_MORE_SUCCESS';

export const crudGetMore = (
    resource,
    pagination,
    sort,
    filter,
    ...
    meta: { resource, fetch: GET_MORE, cancelPrevious },
});
...
export const crudGetOne = (resource, id, include, basePath, cancelPrevious = true) => ({
    type: CRUD_GET_ONE,
    payload: { id, include, basePath },
